...
function FunctionUnit({
    ...
    const { addFunction, removeFunction, selectedFunctions } = useFunctions();
    
    // Проверяем, выбран ли элемент
    const isSelected = selectedFunctions.some(f => f.title === title);
    
    const handleClick = () => {
        // Извлекаем цену из строки "от 15 000 ₽"
